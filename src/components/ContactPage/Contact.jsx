    ...
    return(
        ...
        <div className="w-full md:w-1/3 mb-6 md:mx-28 mx-4 mt-10 order-2 md:order-1">
            ...
            >
                ...
                <span className="text-blue-400 font-semibold">{todayData.time}</span>
                <svg
                className={`w-4 h-4 ml-1 text-blue-400 transition-transform duration-300 ${
                    open ? 'rotate-180' : ''
                }`}
                fill="currentColor"
                viewBox="0 0 20 20"
            ...
            {open && (
                ...
                <ul className="py-2">
                    ...
                    <li
                        ...
                        item.day === todayData.day ? 'font-semibold text-blue-400' : ''
                        }`}
                    >
                        <span>{item.day}</span>
                        <span>{item.time}</span>
