    ...
    <nav className="bg-white shadow-md sticky top-0 z-50 border-b-gray">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-[100px] items-center">
          <Link to="/" className="text-2xl font-bold text-orange-600">Logo</Link>

          <div className="hidden md:flex items-center space-x-10 text-lg font-semibold uppercase">
            <NavLink
            to="/"
            className={({ isActive }) =>
              `px-3 py-1 hover:text-orange-500 transition-colors duration-200 ${
                isActive ? "border-b-1 border-orange-500 text-orange-500" : ""
              }`
            }
          >
            Home
          ...
          >
            ...
            <div className="relative group">
              <button onClick={() => setIsServicesOpen((prev) => !prev)} className="flex items-center text-lg uppercase gap-1 group-hover:text-orange-500 focus:outline-none hover:text-orange-500">
                Services
                <span className="text-lg hover:text-orange-500">▾</span>
              </button>
              {isServicesOpen && (
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white shadow-md">
          <div className="flex flex-col space-y-2 p-4 text-sm font-semibold uppercase">
            ...
            <div className="group">
              <button onClick={() => setIsServicesOpen((prev) => !prev)} className="flex items-center  text-sm uppercase gap-1 group-hover:text-orange-500">
                Services
                <span>▾</span>
              </button>
              {isServicesOpen && (
