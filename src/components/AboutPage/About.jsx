    ...
    return(
        <div>
            <div className="mt-10 mb-12">
                <img className="md:ml-16" src="/images/about.PNG" alt="about us image" />
            </div>

            <div className="bg-gray-100 py-10 px-4 md:px-[180px]">
                <h1 className="text-5xl font-bold text-center text-[#ff7311] mb-10">ABOUT US</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-8 px-4 py-10 py-10 px-4 md:mx-28">
                <div className="bg-white p-4 rounded-lg flex flex-col justify-start h-full min-h-[480px]">
                    <h1 className="text-4xl h-[50px] font-semibold text-[#ff7311] mb-4 text-left">Our Mission</h1>
                ...
                <div className="bg-white p-4 rounded-lg flex flex-col justify-start h-full min-h-[480px]">
                    <h1 className="text-4xl h-[50px] font-semibold text-[#ff7311] mb-4 text-left">Our Vission</h1>
